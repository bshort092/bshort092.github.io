...
d3.json("data/miserables.json").then(function(graph) {
    ...
    var svg = d3.select("#node-diagram").attr("width", width).attr("height", height);
...
//         let divnodeDiagram = d3.select("#node-diagram").classed("fullView", true);
//
//         //fetch the svg bounds
//         this.svgBounds = divnodeDiagram.node().getBoundingClientRect();
//         this.svgWidth = this.svgBounds.width - this.margin.left - this.margin.right;
//         this.svgHeight = 500;
//
//         //add the svg to the div
//         this.svg = divnodeDiagram.append("svg")
